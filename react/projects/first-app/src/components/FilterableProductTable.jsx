...
const FilterableProductTableParent=({products})=>{
    ...
    return(
        <>
        <SearchBar searchText={searchText} isStockedOnly={isStockedOnly} setSearchText={setSearchText} setIsStockedOnly={setIsStockedOnly} />
        <ProductTable searchText={searchText} isStockedOnly={isStockedOnly} products={products} />
        </>
    )

}

const SearchBar=({searchText,isStockedOnly,setSearchText, setIsStockedOnly})=>{
    return(
        <div>
            <form>
                <input type="text"
                ...
                />
                <label>
                    <input type="checkbox" checked={isStockedOnly} onChange={(e)=>setIsStockedOnly(e.target.checked)} /> Only show product in stock
                </label>
            </form>
        </div>
    )
